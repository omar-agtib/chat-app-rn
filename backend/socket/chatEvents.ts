...
export function registerChatEvents(io: SoketIOServer, socket: Socket) {
  ...
  socket.on("newConversation", async (data) => {
    ...
    try {
      ...
      const conversation = await Conversation.create({
        ...
        name: data.name || "", // can be empty ==> direct conv
      ...
      // join this coversation by all online participants
      ...
      // emitconversation to all participants
